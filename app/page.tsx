      ...
      <section id="contact" className="py-24 bg-zinc-900/30">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="flex justify-center gap-4">
            <a href="https://linkedin.com/in/jishnu-janardanan" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 bg-zinc-900/50 border border-zinc-800 rounded-xl hover:border-zinc-700 transition-colors">
